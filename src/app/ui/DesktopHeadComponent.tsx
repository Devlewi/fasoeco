...
const villeAleatoire =
  villesBurkina[Math.floor(Math.random() * villesBurkina.length)];
  ...
  const options: Intl.DateTimeFormatOptions = {
    ...
    month: "long",
    year: "numeric",
    timeZone: "Africa/Ouagadougou", // Force l'heure du Burkina
  };
          ...
          <div className="inner full">
            ...
            <div className="items items-center ">
              ...
              >
                <h1>
                  <img
                    src={`/${locale}/images/logo-faso-eco.webp`}
                    className="logo-image logo-image-dark"
                    alt=""
                    srcSet={`/${locale}/images/logo-faso-eco.webp`}
                  />
