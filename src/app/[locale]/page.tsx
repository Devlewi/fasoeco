...
export async function generateMetadata({
  ...
  return {
    title: locale === "en" ? "FASO ECO | HOME" : "FASO ECO | ACCUEIL",
    description:
      locale === "en"
        ? "FASO ECO is your economic news portal dedicated to FASO"
        : "FASO ECO est votre portail d'information économique dédié au FASO",
